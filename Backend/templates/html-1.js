const templates = {
  ...
  <body>
      <div id="container">
          ...
          <div style="font-size: 36px; font-weight: 600; margin: 8px 0; font-style: oblique; top: 440px;">Dated: ${userData.date}</div>
          <div style="bottom: 40px; right: 40px; width: fit-content; text-align: right;"><img src="${qr}" style="width: 148px; height: 148px;"></div>
          <div style="bottom: 18px; right: 18px; font-size: 14px; width: fit-content;"><a href="${link}" style="text-decoration: none; color: #fff; font-weight: 600;">${link}</a></div>
  ...
  <body>
      <div id="container">
          ...
          <div style="font-size: 38px; font-weight: 600; margin: 16px 30%; font-style: oblique; color: #EA1B35; padding: 10px 30px; border-top: 3px solid #EA1B35; border-bottom: 3px solid #EA1B35; top: 180px; width: fit-content;">${userData.name}</div>
          ...
          <div style="bottom: 18px; right: 18px; font-size: 12px; width: fit-content;"><a href="${userData.link}" style="text-decoration: none; color: #ddd;">${userData.link}</a></div>
          <div style="top: 30px;"><img src="https://certify-hax.s3.ap-south-1.amazonaws.com/certify.png" width="160px"></div>
      </div>
  </body>
  </html>`;
